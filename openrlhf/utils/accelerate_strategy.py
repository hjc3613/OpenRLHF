...
class AccelerateStrategy(ABC):
    ...
    def setup_distributed(self, timeout=timedelta(minutes=30)) -> None:
        ...
        print('word size: ', self.world_size, '\n')
    ...
    def create_optimizer(self, model, **kwargs) -> Optimizer:
        ...
        if AdamOptimizer is DeepSpeedCPUAdam:
            kwargs['fp32_optimizer_states']=(True if self.args.grad_accum_dtype=='fp32' else False)
            print('kwargs["fp32_optimizer_states"]=',kwargs["fp32_optimizer_states"],'\n')
